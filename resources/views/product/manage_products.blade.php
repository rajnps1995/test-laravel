                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Manage Product</h4>

                             <div class="page-title-right">
                                <a href="{{ route('home') }}" <button type="button" id="submit_product" name="submit_product" class="btn btn-primary w-md">Home</button></a>

                                <a href="{{ route('products.index') }}" <button type="button" id="submit_product" name="submit_product" class="btn btn-primary w-md">Add Product</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="app_table" width="100%">
                                    ...
                                    <tbody>
                                        @foreach ($productData as $productDatadetails)
                                            <tr>
                                                <td>{{ $productDatadetails->name }}</td>

                                                <td><img src='/{{ $productDatadetails->user_img }}'
                                                        style='width: 40%;'></td>

                                                <td><a href="{{route('products.edit', encrypt($productDatadetails->id))}}" class="edit_services">
                                                    <i class="fa fa-edit"></i></a>
                                                <a href="{{route('products.destroy', encrypt($productDatadetails->id))}}" class="delete_services">
